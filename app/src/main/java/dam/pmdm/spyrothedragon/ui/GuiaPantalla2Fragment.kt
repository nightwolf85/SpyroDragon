...
import dam.pmdm.spyrothedragon.databinding.FragmentGuiaPantalla2Binding

class GuiaPantalla2Fragment : Fragment() {

    // Usamos el sistema de "Binding" igual que en los fragments ya existentes en la app.
    private var _binding: FragmentGuiaPantalla2Binding? = null
    ...
    override fun onCreateView(
        ...
        // Inflamos el layout de la pantalla 2 de la guía
        _binding = FragmentGuiaPantalla2Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnSiguiente.setOnClickListener {
            ...
            // "action_guia2_to_guia3" es el ID de la flecha en el nav_graph para pasar a la siguiente pantalla de la guía
            findNavController().navigate(R.id.action_guia2_to_guia3)
        }
