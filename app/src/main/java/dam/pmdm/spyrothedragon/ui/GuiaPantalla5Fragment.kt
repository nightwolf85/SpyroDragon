...
import dam.pmdm.spyrothedragon.databinding.FragmentGuiaPantalla5Binding

class GuiaPantalla5Fragment : Fragment() {

    // Usamos el sistema de "Binding" igual que en los fragments ya existentes en la app.
    private var _binding: FragmentGuiaPantalla5Binding? = null
    ...
    override fun onCreateView(
        ...
        // Inflamos el layout de la pantalla 5 de la guía
        _binding = FragmentGuiaPantalla5Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnSiguiente.setOnClickListener {
            ...
            // "action_guia5_to_guia6" es el ID de la flecha en el nav_graph para pasar a la siguiente pantalla de la guía
            findNavController().navigate(R.id.action_guia5_to_guia6)
        }
